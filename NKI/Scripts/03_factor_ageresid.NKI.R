...
coglongdata_baselineageresid<-coglongdata[coglongdata$visitnum==1,c("id","age",allefvars)]
...
save(parallel,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/NKI/Data/parallelsavefactor.ageresid.Rdata") 
load(file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/NKI/Data/parallelsavefactor.ageresid.Rdata") ##already run load in to save computation time
...
ggsave(ggeigs,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/NKIeigsfig.ageresid.pdf",width=6,height=5)
...
save(alleigssaves,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/allfactordataNKI.ageresid.Rdata")
