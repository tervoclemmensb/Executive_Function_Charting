...
save(parallel,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/PNC/Data/parallelsavefactor.Rdata") 
load(file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/PNC/Data/parallelsavefactor.Rdata") ##already run load in to save computation time
...
favalsforeigvis<-fa(coglongdata[,allefvars],nfactors=length(allefvars),rotate ="none",fm="ml",scores="tenBerge")
####
...
ggsave(ggeigs,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/PNCeigsfig.pdf",width=6,height=5)
...
ggsave(fullpanel,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/PNCeigwithloading.panel.pdf",width=8,height=5)
...
write.table(corssaveclean,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/PNCcorrs.csv",row.names=FALSE,col.names=FALSE,sep=",",quote=FALSE)
...
save(alleigssaves,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/allfactordataPNC.Rdata")
