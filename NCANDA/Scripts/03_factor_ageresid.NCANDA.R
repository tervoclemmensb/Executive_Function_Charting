...
coglongdata_baselineageresid<-coglongdata[coglongdata$visitnum==1,c("id","cnp_age",allefvars)]
coglongdata_baselineageresid[,allefvars]<-lapply(coglongdata_baselineageresid[,allefvars],function(x){mgcvresidualizecovar(x,coglongdata_baselineageresid$cnp_age,coglongdata_baselineageresid)})
parallel<-psych::fa.parallel(coglongdata_baselineageresid[,allefvars],n.iter=1000,fm="ml",quant=.95)
save(parallel,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/NCANDA/Data/parallelsavefactor.ageresid.Rdata") 
load(file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/NCANDA/Data/parallelsavefactor.ageresid.Rdata") ##already run load in to save computation time
...
####2 factors by parallel analysis 
favals<-fa(coglongdata_baselineageresid[,allefvars],nfactors=3,rotate ="bifactor",fm="ml",scores="tenBerge")
favalsforeigvis<-fa(coglongdata_baselineageresid[,allefvars],nfactors=max(screedata$vals),rotate ="bifactor",fm="ml",scores="tenBerge")
####
...
# ggsave(ggeigs,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/NCANDAeigsfig.ageresid.pdf",width=6,height=5)
...
# ggsave(fullpanel,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/NCANDAeigwithloading.panel.ageresid.pdf",width=12,height=5)
...
favalswithinforeigvis<-fa(withincorrelations,max(screedatawithin$vals),n.obs=length(which(ndf$haslongitudinal==1)),rotate ="bifactor",fm="ml",scores="tenBerge")
####
...
ggsave(fullpanelwithbotheigs,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/NCANDAeigwithloading.botheigs.ageresid.panel.pdf",width=8,height=5)
...
alleigssaves<-list(screedata=screedata,screedatawithin=screedatawithin,
                   ...
                   nbetween=nrow(coglongdata),
                   nwithin=length(which(ndf$haslongitudinal==1)))
save(alleigssaves,file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/R03_behavioral/Figures/Factorfigs/allfactordataNCANDA.ageresid.Rdata")
####loading plots####
# ###within#####
